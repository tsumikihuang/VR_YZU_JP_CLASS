...
public class HighQualityPlayback : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        videoId = static_class.Courses[static_class.course_id].Youtube_id;  //********************** + "#t="+ static_class.Courses[static_class.course_id].Clips[static_class.clip_id].Time
